...
class ControllerExtensionPaymentAmazonLoginPay extends Controller {
    ...
    public function address() {
		...
		$this->document->getOpenGraph()->setTitle($this->language->get('heading_address'));
    ...
    public function payment() {
		...
		$this->document->getOpenGraph()->setTitle($this->language->get('heading_payment'));
    ...
    public function confirm() {
		...
		$this->document->getOpenGraph()->setTitle($this->language->get('heading_confirm'));
