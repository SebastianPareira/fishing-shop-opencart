...
class ControllerExtensionModuleTTProductTab extends Controller {	
	public function index($setting) {
		...
		$this->language->load('extension/module/tt_product_tab');
      	...
      	$data['tab_recently_viewed'] = $this->language->get('tab_recently_viewed');
		...
		if ($setting['recently_viewed_products']) {
			$recently_viewed_results = $this->load->controller('extension/module/recently_viewed/getRecentProducts', $setting['limit']);

			if ($recently_viewed_results) {
				foreach ($recently_viewed_results as $result) {
					if ($result['image']) {
