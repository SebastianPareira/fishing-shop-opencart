...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$this->document->getOpenGraph()->setTitle($category_info['meta_title']);
			...
			$this->document->getOpenGraph()->setImage($data['thumb']);
			...
			foreach ($results as $result) {
				...
				$data['categories'][] = array(
					'name' => $result['name'] . ($this->config->get('config_product_count') ? ' (' . $totalProducts . ')' : ''),
