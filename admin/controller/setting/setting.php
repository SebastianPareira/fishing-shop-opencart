...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_admin_currency'])) {
			$data['config_admin_currency'] = $this->request->post['config_admin_currency'];
		} else {
			$data['config_admin_currency'] = $this->config->get('config_admin_currency');
		}

		if (isset($this->request->post['config_seo_title_suffix'])) {
			$data['config_seo_title_suffix'] = $this->request->post['config_seo_title_suffix'];
		} else {
			$data['config_seo_title_suffix'] = $this->config->get('config_seo_title_suffix');
		}

		if (isset($this->request->post['config_seo_description_suffix'])) {
			$data['config_seo_description_suffix'] = $this->request->post['config_seo_description_suffix'];
		} else {
			$data['config_seo_description_suffix'] = $this->config->get('config_seo_description_suffix');
		}
