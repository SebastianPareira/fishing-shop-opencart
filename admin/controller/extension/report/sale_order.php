	...
	public function report() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'tax'        => $this->currency->format($result['tax'], $this->config->get('config_admin_currency')),
				'total'      => $this->currency->format($result['total'], $this->config->get('config_admin_currency'))
			);
		}
