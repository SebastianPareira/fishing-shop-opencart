...
class ControllerExtensionModuleTTProductTab extends Controller {
	...
	public function index() {   
		...
		$data['entry_recently_viewed'] = $this->language->get('entry_recently_viewed');
		...
		if (isset($this->request->post['recently_viewed_products'])) {
			$data['recently_viewed_products'] = $this->request->post['recently_viewed_products'];
		} elseif (!empty($module_info)) {
			$data['recently_viewed_products'] = $module_info['recently_viewed_products'];
		} else {
			$data['recently_viewed_products'] = "1";
		}
	...
	protected function validate() {
		...
		if(!isset($this->request->post['recently_viewed_products'])){
			$this->request->post['recently_viewed_products'] = 0;
		}
