...
class ControllerExtensionPaymentAmazonLoginPay extends Controller {
	...
	public function index() {
		...
		} elseif (in_array($this->config->get('config_admin_currency'), array('EUR', 'GBP', 'USD'))) {
			$data['payment_amazon_login_pay_payment_region'] = $this->config->get('config_admin_currency');
		} else {
